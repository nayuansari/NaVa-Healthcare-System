...
class DiseaseModel:
    ...
    def __init__(self):
        ...
        self.diseases = self.disease_list('D:/final_project/Datasets/dataset.csv')
    ...
    def describe_disease(self, disease_name):
        ...
        desc_df = pd.read_csv('D:/final_project/Datasets/symptom_Description.csv')
    ...
    def disease_precautions(self, disease_name):
        ...
        prec_df = pd.read_csv("D:/final_project/Datasets/symptom_precaution.csv")
    ...
    def disease_list(self, kaggle_dataset):
        ...
        df = pd.read_csv('D:/final_project/Datasets/clean_dataset.tsv', sep='\t')
        # Preprocessing
        y_data = df.iloc[:,-1]
        X_data = df.iloc[:,:-1]
