...
# import the dataset
dataset_df = pd.read_csv("D:/final_project/Datasets/dataset.csv")
...
clean_df.to_csv("D:/final_project/Datasets/clean_dataset.tsv", sep='\t', index=False)
...
model.save_model("D:/final_project/models/xgboost_model.json")
